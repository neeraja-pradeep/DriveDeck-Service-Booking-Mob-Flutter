...
class _$SessionImpl extends _Session {
  ...
  @override
  String toString() {
    return 'Session(sessionId: $sessionId, xcsrfToken: $xcsrfToken, userId: $userId, createdAt: $createdAt, expiresAt: $expiresAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, sessionId, xcsrfToken, userId, createdAt, expiresAt);
...
abstract class _Session extends Session {
  const factory _Session(
      ...
      required final String xcsrfToken,
      required final String userId,
      required final DateTime createdAt,
      final DateTime? expiresAt}) = _$SessionImpl;
