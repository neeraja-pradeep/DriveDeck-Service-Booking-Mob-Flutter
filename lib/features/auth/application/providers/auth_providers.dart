...
/// - **XCSRF**: Cross-site request forgery protection
/// - **Retry**: Automatic retry for transient network failures
///
...
/// **Dependencies**: SecureStore for token storage
...
final Provider<ApiClient> apiClientProvider = Provider<ApiClient>((ref) {
  ...
  return ApiClient(
    ...
    onSessionExpired: () {
      // Invalidate auth state when session expires to trigger re-evaluation
