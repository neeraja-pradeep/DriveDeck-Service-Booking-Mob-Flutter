...
abstract class _OpeningHours extends OpeningHours {
  const factory _OpeningHours(
      {required final DayHours monday,
      required final DayHours tuesday,
      required final DayHours wednesday,
      required final DayHours thursday,
      required final DayHours friday,
      required final DayHours saturday,
      required final DayHours sunday}) = _$OpeningHoursImpl;
...
abstract class $DayHoursCopyWith<$Res> {
  ...
  @useResult
  $Res call({String openTime, String closeTime, bool isClosed});
}
...
class _$DayHoursImpl extends _DayHours {
  ...
  @override
  String toString() {
    return 'DayHours(openTime: $openTime, closeTime: $closeTime, isClosed: $isClosed)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, openTime, closeTime, isClosed);
