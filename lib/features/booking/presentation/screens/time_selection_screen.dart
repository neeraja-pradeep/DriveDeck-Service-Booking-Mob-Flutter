      ...
      body: SafeArea(
        child: Column(
          children: [
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildAvailableTimeSection(availableSlots, selectedTimeSlot),
            ...
            // Next button
            _buildNextButton(selectedDate, selectedTimeSlot, bookingData),
          ],
        ),
      ),
    );
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: AppTypography.bodyMedium.copyWith(
                        ...
                        fontWeight:
                            isSelected || isTodayDate ? FontWeight.w600 : null,
                      ),
                    ),
                  ),
                ),
                ...
                onTap: isAvailable
                    ? () {
                        ref.read(selectedTimeSlotProvider.notifier).state =
                            slot;
                        ref.read(bookingDataProvider.notifier).selectTimeSlot(
                              slot.id,
                              slot.displayTime,
                            );
                      }
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor:
                  isEnabled ? AppColors.primary : AppColors.grey300,
