    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Price
          _buildPriceRow('Price', '\$${bookingData.subtotal.toStringAsFixed(2)}'),

          SizedBox(height: 12.h),

          // Admin fee
          _buildPriceRow('Admin fee', '\$${bookingData.adminFee.toStringAsFixed(2)}'),
          ...
          ElevatedButton(
            onPressed: () {
              if (controller.text.isNotEmpty) {
                ...
                ref.read(bookingDataProvider.notifier).applyPromoCode(
