...
/// Bookings route
class BookingsRoute extends AppRoute {
  const BookingsRoute();

  @override
  String get path => '/bookings';
...
/// Shops route
class ShopsRoute extends AppRoute {
  const ShopsRoute();

  @override
  String get path => '/shops';
...
/// Shop detail route with shop ID parameter
class ShopDetailRoute extends AppRoute {
  const ShopDetailRoute({required this.shopId});

  final String shopId;

  @override
  String get path => '/shop/$shopId';
...
/// Booking detail route with booking ID parameter
class BookingDetailRoute extends AppRoute {
  const BookingDetailRoute({required this.bookingId});
